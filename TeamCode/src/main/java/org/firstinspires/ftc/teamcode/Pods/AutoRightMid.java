...
public class AutoRightMid extends LinearOpMode {
    ...
    public static double BackAlign_DISTANCE_THRESHOLD = 1;//0.5;
...
//        distanceAlign(drive);
        ...
        drive.update();
        drive.updatePoseEstimate();
        dropPose3 = drive.getPoseEstimate();
...
//        distanceAlign(drive);
        ...
        drive.update();
        drive.updatePoseEstimate();
        dropPose4 = drive.getPoseEstimate();
...
//        distanceAlign(drive);
        ...
        telemetry.addData("time",elapsedSeconds);
